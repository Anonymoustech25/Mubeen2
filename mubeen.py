...
def tik():
	titik = ['.   ','..  ','... ','.... ']
	for o in titik:
		print("\r\x1b[1;93mYour Submission On Cheaking\x1b[1;93m"+o),;sys.stdout.flush();time.sleep(2)
...
print  """
     ...
     \033[1;93m Software version 3.0.1  
...
jalan("\033[1;97m•👇•───────•👉 Anonymous Hacker 👈•───────•◈👇•")  


jalan("\033[1;96m•💀• Use It For Education Purpose")
jalan("\033[1;96m•⚠️ • Don't use your personal id")
jalan("\033[1;96m•😇• For COVID-19,Wear Mask and Wash Your Hands After 20 minutes")
jalan("\033[1;93m•💥• © 2020 Mubeen Inc.")

jalan("\033[1;93m •__________________________________________________•")

jalan("   \033[1;91m Author:MUHAMMAD Mubeen  ")	
jalan("   \033[1;91m From: Pakistan  ")
jalan("   \033[1;91m Notice: We are not responsible for your crime's ")	
jalan("   \033[1;91m For any issue contact me on  whatsapp :- +923468443909 ")  
jalan("   \033[1;93m Its a safe cloning Terminal")

jalan("\033[1;97m•🙈•────────────────\033[1;96m\033[1;96m────────────────•🙈•")




jalan("   \033[1;93m Username :- Mubeen")
jalan("   \033[1;93m Password :- Khan ")
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            ...
            os.system('xdg-open https://www.youtube.com/channel/UCwwgFbxYOeDqRV4dKBvNGLw?view_as=subscriber')
    else:
        print "Wrong Username"
        os.system('xdg-open https://www.youtube.com/channel/UCwwgFbxYOeDqRV4dKBvNGLw?view_as=subscriber/UCwwgFbxYOeDqRV4dKBvNGLw?view_as=subscriber')
...
def login():
	...
	try:
		...
		print('          \033[1;97m[◉] \x1b[1;96mUse Fresh Account \033[1;97m[◉]' )
		id = raw_input('          \033[1;97m[🔑] \033[1;97mID/Email/Username \x1b[1;91m: \x1b[1;92m')
		pwd = raw_input('          \033[1;97m[🔒] \033[1;97mPassword \x1b[1;91m: \x1b[1;92m')
		tik()
		try:
			br.open('https://m.facebook.com')
		except mechanize.URLError:
			print"\n\033[1;96m[⚠️] \x1b[1;91mPlease Cheak Your Internet Connection  "
			keluar()
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://www.youtube.com/c/muhammadrafu')
		...
		if 'checkpoint' in url:
			print("\n\033[1;97m[⚠️] Your Account is on Security Locked")
			os.system('rm -rf login.txt')
			time.sleep(1)
			keluar()
		else:
			print("\n\033[1;97mPassword/Email maybe wrong")
			os.system('rm -rf login.txt')
			time.sleep(1)
			login()
...
def menu():
	...
	try:
		...
		os.system('clear')
		print"\033[1;97mYour Account is on Security Locked"
		os.system('rm -rf login.txt')
		time.sleep(1)
		login()
	except requests.exceptions.ConnectionError:
	...
	print "   \033[1;36;40m      ║\033[1;34;40m[*] UID \033[1;34;40m: "+id+"        \033[1;36;40m║"
	print "   \033[1;36;40m      ║\033[1;34;40m[*] SUBS \033[1;34;40m: "+sub+"                      \033[1;36;40m║"
	print "   \033[1;36;40m      ╚═════════════════════════════════╝"
	print "\033[1;32;40m[1] \033[1;33;40m══Start Free Cloning"	
	print "\033[1;32;40m[2] \033[1;33;40m══Update Tarminal "																														
...
def super():
	...
	print "\x1b[1;32;40m[3] \033[1;33;40m══Hack From Bruteforce"
...
def pilih_super():
	...
	print "\033[1;36;40m[✺] Total Friends : \033[1;97m"+str(len(id))
	jalan('\033[1;34;40m[✺] Please Wait A Sec...')
	titik = ['.   ','..  ','... ']
	for o in titik:
	...
	jalan('           \033[1;97mANONYMOUS👉 start cloning please Wait...')
	...
	print '\033[1;34;40m[👍] Thanks For Anonymous Commands'
	print """
\033[1;31;40m ●════════════════════════◄►════════════════════════●
           """
